...
export default function Footer() {
  ...
  return (
    ...
    >
      ...
      <div className="divider w-full mt-[5rem] bg-[#fff] h-[1px] w-[95vw] absolute bottom-[7rem]"></div>
      <div className="relative w-full flex justify-between items-center mt-[15rem] mb-[2rem]">
